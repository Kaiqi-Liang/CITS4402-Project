...
def kalman(hypothesis, non_assignment_cost = None):
	'''
	Tracking phase to follow candidate small objects throughout frames and 
...
def template_matching(unassigned_tracks, frame, previous_frame):
	'''
	Purpose: to run a local search algorithm
